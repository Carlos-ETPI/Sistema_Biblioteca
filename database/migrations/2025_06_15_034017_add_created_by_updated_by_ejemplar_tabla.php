...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('EJEMPLAR', function (Blueprint $table) {
            if (!Schema::hasColumn('EJEMPLAR', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable(); // quitamos el after
            }
            if (!Schema::hasColumn('EJEMPLAR', 'updated_by')) {
                $table->unsignedBigInteger('updated_by')->nullable();
            }
            if (!Schema::hasColumn('EJEMPLAR', 'created_at')) {
                $table->timestamp('created_at')->nullable();
            }
            if (!Schema::hasColumn('EJEMPLAR', 'updated_at')) {
