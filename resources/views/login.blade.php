...
<html lang="en">
    <head>
        ...
        <!-- SB Admin CSS (opcional, si quieres el estilo original) -->
        <link href="https://cdn.jsdelivr.net/gh/StartBootstrap/startbootstrap-sb-admin@7.0.7/dist/css/styles.css" rel="stylesheet" />
    </head>
    <body class="" style="background-image: url('/image/login.jpg'); background-size: cover; background-position: center;">
